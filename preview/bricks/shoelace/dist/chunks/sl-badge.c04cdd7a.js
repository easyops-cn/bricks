/*! For license information please see sl-badge.c04cdd7a.js.LICENSE.txt */
"use strict";(self.webpackChunk_next_bricks_shoelace=self.webpackChunk_next_bricks_shoelace||[]).push([[2947],{944:(e,r,t)=>{t.r(r),t(6136),t(5517)},5517:(e,r,t)=>{t(2969),t(3467);var s=t(4124);function a(e){document.documentElement.classList["dark"===e||"dark-v2"===e?"add":"remove"]("sl-theme-dark")}t(1744),(0,s.t)(t.p),a(document.documentElement.dataset.theme),window.addEventListener("theme.change",(e=>{a(e.detail)}))},738:(e,r,t)=>{t.d(r,{Z:()=>n});var s=t(9601),a=t.n(s),l=t(2609),o=t.n(l)()(a());o.push([e.id,":root,\n.sl-theme-dark{--sl-z-index-drawer:1000;--sl-z-index-dialog:1000;--sl-z-index-dropdown:1050;--sl-z-index-toast:1000;--sl-z-index-tooltip:1070}.sl-toast-stack{width:100%;left:0;right:auto;overflow:initial;pointer-events:none}.sl-toast-stack > sl-alert{pointer-events:all}",""]);const n=o},1744:(e,r,t)=>{var s=t(6062),a=t.n(s),l=t(4036),o=t.n(l),n=t(6793),i=t.n(n),d=t(7892),c=t.n(d),u=t(1173),p=t.n(u),h=t(2464),b=t.n(h),g=t(738),v={};v.styleTagTransform=b(),v.setAttributes=c(),v.insert=i().bind(null,"head"),v.domAPI=o(),v.insertStyleElement=p(),a()(g.Z,v),g.Z&&g.Z.locals&&g.Z.locals},6136:(e,r,t)=>{var s=t(7979),a=t(9832),l=t(3030),o=t(8427),n=t(5166),i=t(1452),d=o.iv`
  ${i.Z}
...
`;let c=class extends n.Z{constructor(){super(...arguments),this.variant="primary",this.pill=!1,this.pulse=!1}render(){return o.dy`
      <slot
        part="base"
        class=${(0,a.$)({badge:!0,"badge--primary":"primary"===this.variant,"badge--success":"success"===this.variant,"badge--neutral":"neutral"===this.variant,"badge--warning":"warning"===this.variant,"badge--danger":"danger"===this.variant,"badge--pill":this.pill,"badge--pulse":this.pulse})}
        role="status"
      ></slot>
    `}};c.styles=d,(0,s.u2)([(0,l.Cb)({reflect:!0})],c.prototype,"variant",2),(0,s.u2)([(0,l.Cb)({type:Boolean,reflect:!0})],c.prototype,"pill",2),(0,s.u2)([(0,l.Cb)({type:Boolean,reflect:!0})],c.prototype,"pulse",2),c=(0,s.u2)([(0,l.Mo)("sl-badge")],c)},1452:(e,r,t)=>{t.d(r,{Z:()=>s});const s=t(8427).iv`
  :host {
...
//# sourceMappingURL=sl-badge.c04cdd7a.js.map