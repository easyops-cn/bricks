...
`},333:(e,t,r)=>{r.d(t,{c:()=>s});var a=r(3280),o=r(5258),s=class extends o.c2{};(0,o.XC)(a.k)},4243:(e,t,r)=>{var a=r(7324),o=r(5024),s=o.AH`
  ${a.$}
...
`,i=r(333),n=r(7489),l=r(7012),c=r(2489),d=class extends n.f{constructor(){super(...arguments),this.localize=new i.c(this),this.value=0,this.label=""}updated(e){if(super.updated(e),e.has("value")){const e=parseFloat(getComputedStyle(this.indicator).getPropertyValue("r")),t=2*Math.PI*e,r=t-this.value/100*t;this.indicatorOffset=`${r}px`}}render(){return o.qy`
      <div
        part="base"
        class="progress-ring"
        role="progressbar"
    ...
    `}};d.styles=s,(0,l.Cc)([(0,c.P)(".progress-ring__indicator")],d.prototype,"indicator",2),(0,l.Cc)([(0,c.wk)()],d.prototype,"indicatorOffset",2),(0,l.Cc)([(0,c.MZ)({type:Number,reflect:!0})],d.prototype,"value",2),(0,l.Cc)([(0,c.MZ)()],d.prototype,"label",2),d.define("sl-progress-ring"),r(3280)}}]);
//# sourceMappingURL=sl-progress-ring.8637e945.js.map