"use strict";(self.webpackChunk_next_bricks_shoelace=self.webpackChunk_next_bricks_shoelace||[]).push([[4767],{4767:(e,t,l)=>{var s=l(7979),i=(l(7290),l(2613),l(3690),l(2868)),o=l(9832),a=l(3030),r=l(5317),n=l(4007),c=l(4573),p=l(962),d=l(8427),h=l(1321),u=l(2421),m=l(7173),b=l(3005),g=l(5166),v=l(1452),f=l(9728),y=d.iv`
  ${v.Z}
  ${f.Z}
...
`;let _=class extends g.Z{constructor(){super(...arguments),this.formControlController=new n.pY(this,{assumeInteractionOn:["sl-blur","sl-input"]}),this.hasSlotController=new p.rc(this,"help-text","label"),this.localize=new h.V(this),this.typeToSelectString="",this.hasFocus=!1,this.displayLabel="",this.selectedOptions=[],this.name="",this.value="",this.defaultValue="",this.size="medium",this.placeholder="",this.multiple=!1,this.maxOptionsVisible=3,this.disabled=!1,this.clearable=!1,this.open=!1,this.hoist=!1,this.filled=!1,this.pill=!1,this.label="",this.placement="bottom",this.helpText="",this.form="",this.required=!1,this.handleDocumentFocusIn=e=>{const t=e.composedPath();this&&!t.includes(this)&&this.hide()},this.handleDocumentKeyDown=e=>{const t=e.target,l=null!==t.closest(".select__clear"),s=null!==t.closest("sl-icon-button");if(!l&&!s){if("Escape"===e.key&&this.open&&(e.preventDefault(),e.stopPropagation(),this.hide(),this.displayInput.focus({preventScroll:!0})),"Enter"===e.key||" "===e.key&&""===this.typeToSelectString)return e.preventDefault(),e.stopImmediatePropagation(),this.open?void(this.currentOption&&!this.currentOption.disabled&&(this.multiple?this.toggleOptionSelection(this.currentOption):this.setSelectedOptions(this.currentOption),this.updateComplete.then((()=>{this.emit("sl-input"),this.emit("sl-change")})),this.multiple||(this.hide(),this.displayInput.focus({preventScroll:!0})))):void this.show();if(["ArrowUp","ArrowDown","Home","End"].includes(e.key)){const t=this.getAllOptions(),l=t.indexOf(this.currentOption);let s=Math.max(0,l);if(e.preventDefault(),!this.open&&(this.show(),this.currentOption))return;"ArrowDown"===e.key?(s=l+1,s>t.length-1&&(s=0)):"ArrowUp"===e.key?(s=l-1,s<0&&(s=t.length-1)):"Home"===e.key?s=0:"End"===e.key&&(s=t.length-1),this.setCurrentOption(t[s])}if(1===e.key.length||"Backspace"===e.key){const t=this.getAllOptions();if(e.metaKey||e.ctrlKey||e.altKey)return;if(!this.open){if("Backspace"===e.key)return;this.show()}e.stopPropagation(),e.preventDefault(),clearTimeout(this.typeToSelectTimeout),this.typeToSelectTimeout=window.setTimeout((()=>this.typeToSelectString=""),1e3),"Backspace"===e.key?this.typeToSelectString=this.typeToSelectString.slice(0,-1):this.typeToSelectString+=e.key.toLowerCase();for(const e of t)if(e.getTextLabel().toLowerCase().startsWith(this.typeToSelectString)){this.setCurrentOption(e);break}}}},this.handleDocumentMouseDown=e=>{const t=e.composedPath();this&&!t.includes(this)&&this.hide()}}get validity(){return this.valueInput.validity}get validationMessage(){return this.valueInput.validationMessage}connectedCallback(){super.connectedCallback(),this.open=!1}addOpenListeners(){document.addEventListener("focusin",this.handleDocumentFocusIn),document.addEventListener("keydown",this.handleDocumentKeyDown),document.addEventListener("mousedown",this.handleDocumentMouseDown)}removeOpenListeners(){document.removeEventListener("focusin",this.handleDocumentFocusIn),document.removeEventListener("keydown",this.handleDocumentKeyDown),document.removeEventListener("mousedown",this.handleDocumentMouseDown)}handleFocus(){this.hasFocus=!0,this.displayInput.setSelectionRange(0,0),this.emit("sl-focus")}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleLabelClick(){this.displayInput.focus()}handleComboboxMouseDown(e){const t=e.composedPath().some((e=>e instanceof Element&&"sl-icon-button"===e.tagName.toLowerCase()));this.disabled||t||(e.preventDefault(),this.displayInput.focus({preventScroll:!0}),this.open=!this.open)}handleComboboxKeyDown(e){e.stopPropagation(),this.handleDocumentKeyDown(e)}handleClearClick(e){e.stopPropagation(),""!==this.value&&(this.setSelectedOptions([]),this.displayInput.focus({preventScroll:!0}),this.updateComplete.then((()=>{this.emit("sl-clear"),this.emit("sl-input"),this.emit("sl-change")})))}handleClearMouseDown(e){e.stopPropagation(),e.preventDefault()}handleOptionClick(e){const t=e.target.closest("sl-option"),l=this.value;t&&!t.disabled&&(this.multiple?this.toggleOptionSelection(t):this.setSelectedOptions(t),this.updateComplete.then((()=>this.displayInput.focus({preventScroll:!0}))),this.value!==l&&this.updateComplete.then((()=>{this.emit("sl-input"),this.emit("sl-change")})),this.multiple||(this.hide(),this.displayInput.focus({preventScroll:!0})))}handleDefaultSlotChange(){const e=this.getAllOptions(),t=Array.isArray(this.value)?this.value:[this.value],l=[];customElements.get("sl-option")?(e.forEach((e=>l.push(e.value))),this.setSelectedOptions(e.filter((e=>t.includes(e.value))))):customElements.whenDefined("sl-option").then((()=>this.handleDefaultSlotChange()))}handleTagRemove(e,t){e.stopPropagation(),this.disabled||(this.toggleOptionSelection(t,!1),this.updateComplete.then((()=>{this.emit("sl-input"),this.emit("sl-change")})))}getAllOptions(){return[...this.querySelectorAll("sl-option")]}getFirstOption(){return this.querySelector("sl-option")}setCurrentOption(e){this.getAllOptions().forEach((e=>{e.current=!1,e.tabIndex=-1})),e&&(this.currentOption=e,e.current=!0,e.tabIndex=0,e.focus())}setSelectedOptions(e){const t=this.getAllOptions(),l=Array.isArray(e)?e:[e];t.forEach((e=>e.selected=!1)),l.length&&l.forEach((e=>e.selected=!0)),this.selectionChanged()}toggleOptionSelection(e,t){e.selected=!0===t||!1===t?t:!e.selected,this.selectionChanged()}selectionChanged(){var e,t,l,s;this.selectedOptions=this.getAllOptions().filter((e=>e.selected)),this.multiple?(this.value=this.selectedOptions.map((e=>e.value)),this.placeholder&&0===this.value.length?this.displayLabel="":this.displayLabel=this.localize.term("numOptionsSelected",this.selectedOptions.length)):(this.value=null!=(t=null==(e=this.selectedOptions[0])?void 0:e.value)?t:"",this.displayLabel=null!=(s=null==(l=this.selectedOptions[0])?void 0:l.getTextLabel())?s:""),this.updateComplete.then((()=>{this.formControlController.updateValidity()}))}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleDisabledChange(){this.disabled&&(this.open=!1,this.handleOpenChange())}handleValueChange(){const e=this.getAllOptions(),t=Array.isArray(this.value)?this.value:[this.value];this.setSelectedOptions(e.filter((e=>t.includes(e.value))))}async handleOpenChange(){if(this.open&&!this.disabled){this.setCurrentOption(this.selectedOptions[0]||this.getFirstOption()),this.emit("sl-show"),this.addOpenListeners(),await(0,i.U_)(this),this.listbox.hidden=!1,this.popup.active=!0,requestAnimationFrame((()=>{this.setCurrentOption(this.currentOption)}));const{keyframes:e,options:t}=(0,c.O8)(this,"select.show",{dir:this.localize.dir()});await(0,i.nv)(this.popup.popup,e,t),this.currentOption&&(0,u.zT)(this.currentOption,this.listbox,"vertical","auto"),this.emit("sl-after-show")}else{this.emit("sl-hide"),this.removeOpenListeners(),await(0,i.U_)(this);const{keyframes:e,options:t}=(0,c.O8)(this,"select.hide",{dir:this.localize.dir()});await(0,i.nv)(this.popup.popup,e,t),this.listbox.hidden=!0,this.popup.active=!1,this.emit("sl-after-hide")}}async show(){if(!this.open&&!this.disabled)return this.open=!0,(0,m.m)(this,"sl-after-show");this.open=!1}async hide(){if(this.open&&!this.disabled)return this.open=!1,(0,m.m)(this,"sl-after-hide");this.open=!1}checkValidity(){return this.valueInput.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.valueInput.reportValidity()}setCustomValidity(e){this.valueInput.setCustomValidity(e),this.formControlController.updateValidity()}focus(e){this.displayInput.focus(e)}blur(){this.displayInput.blur()}render(){const e=this.hasSlotController.test("label"),t=this.hasSlotController.test("help-text"),l=!!this.label||!!e,s=!!this.helpText||!!t,i=this.clearable&&!this.disabled&&this.value.length>0,a=this.placeholder&&0===this.value.length;return d.dy`
            ...
            >
              ...
              ${this.multiple?d.dy`
                    <div part="tags" class="select__tags">
                      ${this.selectedOptions.map(((e,t)=>t<this.maxOptionsVisible||this.maxOptionsVisible<=0?d.dy`
                            <sl-tag
                              part="tag"
                              exportparts="
                                base:tag__base,
                          ...
                          `:t===this.maxOptionsVisible?d.dy` <sl-tag size=${this.size}> +${this.selectedOptions.length-t} </sl-tag> `:null))}
                    </div>
                  `:""}
    ...
    `}};_.styles=y,(0,s.u2)([(0,a.IO)(".select")],_.prototype,"popup",2),(0,s.u2)([(0,a.IO)(".select__combobox")],_.prototype,"combobox",2),(0,s.u2)([(0,a.IO)(".select__display-input")],_.prototype,"displayInput",2),(0,s.u2)([(0,a.IO)(".select__value-input")],_.prototype,"valueInput",2),(0,s.u2)([(0,a.IO)(".select__listbox")],_.prototype,"listbox",2),(0,s.u2)([(0,a.SB)()],_.prototype,"hasFocus",2),(0,s.u2)([(0,a.SB)()],_.prototype,"displayLabel",2),(0,s.u2)([(0,a.SB)()],_.prototype,"currentOption",2),(0,s.u2)([(0,a.SB)()],_.prototype,"selectedOptions",2),(0,s.u2)([(0,a.Cb)()],_.prototype,"name",2),(0,s.u2)([(0,a.Cb)({converter:{fromAttribute:e=>e.split(" "),toAttribute:e=>e.join(" ")}})],_.prototype,"value",2),(0,s.u2)([(0,r.L)()],_.prototype,"defaultValue",2),(0,s.u2)([(0,a.Cb)({reflect:!0})],_.prototype,"size",2),(0,s.u2)([(0,a.Cb)()],_.prototype,"placeholder",2),(0,s.u2)([(0,a.Cb)({type:Boolean,reflect:!0})],_.prototype,"multiple",2),(0,s.u2)([(0,a.Cb)({attribute:"max-options-visible",type:Number})],_.prototype,"maxOptionsVisible",2),(0,s.u2)([(0,a.Cb)({type:Boolean,reflect:!0})],_.prototype,"disabled",2),(0,s.u2)([(0,a.Cb)({type:Boolean})],_.prototype,"clearable",2),(0,s.u2)([(0,a.Cb)({type:Boolean,reflect:!0})],_.prototype,"open",2),(0,s.u2)([(0,a.Cb)({type:Boolean})],_.prototype,"hoist",2),(0,s.u2)([(0,a.Cb)({type:Boolean,reflect:!0})],_.prototype,"filled",2),(0,s.u2)([(0,a.Cb)({type:Boolean,reflect:!0})],_.prototype,"pill",2),(0,s.u2)([(0,a.Cb)()],_.prototype,"label",2),(0,s.u2)([(0,a.Cb)({reflect:!0})],_.prototype,"placement",2),(0,s.u2)([(0,a.Cb)({attribute:"help-text"})],_.prototype,"helpText",2),(0,s.u2)([(0,a.Cb)({reflect:!0})],_.prototype,"form",2),(0,s.u2)([(0,a.Cb)({type:Boolean,reflect:!0})],_.prototype,"required",2),(0,s.u2)([(0,b.Y)("disabled",{waitUntilFirstUpdate:!0})],_.prototype,"handleDisabledChange",1),(0,s.u2)([(0,b.Y)("value",{waitUntilFirstUpdate:!0})],_.prototype,"handleValueChange",1),(0,s.u2)([(0,b.Y)("open",{waitUntilFirstUpdate:!0})],_.prototype,"handleOpenChange",1),_=(0,s.u2)([(0,a.Mo)("sl-select")],_),(0,c.jx)("select.show",{keyframes:[{opacity:0,scale:.9},{opacity:1,scale:1}],options:{duration:100,easing:"ease"}}),(0,c.jx)("select.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.9}],options:{duration:100,easing:"ease"}})},3690:(e,t,l)=>{var s=l(7979),i=(l(9026),l(9832)),o=l(3030),a=l(8427),r=l(1321),n=l(5166),c=l(1452),p=a.iv`
  ${c.Z}
...
`;let d=class extends n.Z{constructor(){super(...arguments),this.localize=new r.V(this),this.variant="neutral",this.size="medium",this.pill=!1,this.removable=!1}handleRemoveClick(){this.emit("sl-remove")}render(){return a.dy`
      <span
        part="base"
    ...
    `}};d.styles=p,(0,s.u2)([(0,o.Cb)({reflect:!0})],d.prototype,"variant",2),(0,s.u2)([(0,o.Cb)({reflect:!0})],d.prototype,"size",2),(0,s.u2)([(0,o.Cb)({type:Boolean,reflect:!0})],d.prototype,"pill",2),(0,s.u2)([(0,o.Cb)({type:Boolean})],d.prototype,"removable",2),d=(0,s.u2)([(0,o.Mo)("sl-tag")],d)},2421:(e,t,l)=>{l.d(t,{M4:()=>i,zT:()=>a,gG:()=>o});const s=new Set;function i(e){if(s.add(e),!document.body.classList.contains("sl-scroll-lock")){const e=function(){const e=document.documentElement.clientWidth;return Math.abs(window.innerWidth-e)}();document.body.classList.add("sl-scroll-lock"),document.body.style.setProperty("--sl-scroll-lock-size",`${e}px`)}}function o(e){s.delete(e),0===s.size&&(document.body.classList.remove("sl-scroll-lock"),document.body.style.removeProperty("--sl-scroll-lock-size"))}function a(e,t,l="vertical",s="smooth"){const i=function(e,t){return{top:Math.round(e.getBoundingClientRect().top-t.getBoundingClientRect().top),left:Math.round(e.getBoundingClientRect().left-t.getBoundingClientRect().left)}}(e,t),o=i.top+t.scrollTop,a=i.left+t.scrollLeft,r=t.scrollLeft,n=t.scrollLeft+t.offsetWidth,c=t.scrollTop,p=t.scrollTop+t.offsetHeight;"horizontal"!==l&&"both"!==l||(a<r?t.scrollTo({left:a,behavior:s}):a+e.clientWidth>n&&t.scrollTo({left:a-t.offsetWidth+e.clientWidth,behavior:s})),"vertical"!==l&&"both"!==l||(o<c?t.scrollTo({top:o,behavior:s}):o+e.clientHeight>p&&t.scrollTo({top:o-t.offsetHeight+e.clientHeight,behavior:s}))}}}]);
//# sourceMappingURL=4767.7993cf55.js.map