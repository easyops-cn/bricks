"use strict";(self.webpackChunk_next_bricks_shoelace=self.webpackChunk_next_bricks_shoelace||[]).push([[196],{5502:(t,a,e)=>{var o=e(7324),s=e(5024),i=s.AH`
  ${o.$}
...
`,r=e(4029),l=e(1382),n=e(333),c=e(5794),b=e(7489),d=e(7012),p=e(3788),h=e(2489),u=class extends b.f{constructor(){super(...arguments),this.localize=new n.c(this),this.tabs=[],this.panels=[],this.hasScrollControls=!1,this.placement="top",this.activation="auto",this.noScrollControls=!1}connectedCallback(){const t=Promise.all([customElements.whenDefined("sl-tab"),customElements.whenDefined("sl-tab-panel")]);super.connectedCallback(),this.resizeObserver=new ResizeObserver((()=>{this.repositionIndicator(),this.updateScrollControls()})),this.mutationObserver=new MutationObserver((t=>{t.some((t=>!["aria-labelledby","aria-controls"].includes(t.attributeName)))&&setTimeout((()=>this.setAriaLabels())),t.some((t=>"disabled"===t.attributeName))&&this.syncTabsAndPanels()})),this.updateComplete.then((()=>{this.syncTabsAndPanels(),this.mutationObserver.observe(this,{attributes:!0,childList:!0,subtree:!0}),this.resizeObserver.observe(this.nav),t.then((()=>{new IntersectionObserver(((t,a)=>{var e;t[0].intersectionRatio>0&&(this.setAriaLabels(),this.setActiveTab(null!=(e=this.getActiveTab())?e:this.tabs[0],{emitEvents:!1}),a.unobserve(t[0].target))})).observe(this.tabGroup)}))}))}disconnectedCallback(){super.disconnectedCallback(),this.mutationObserver.disconnect(),this.resizeObserver.unobserve(this.nav)}getAllTabs(t={includeDisabled:!0}){return[...this.shadowRoot.querySelector('slot[name="nav"]').assignedElements()].filter((a=>t.includeDisabled?"sl-tab"===a.tagName.toLowerCase():"sl-tab"===a.tagName.toLowerCase()&&!a.disabled))}getAllPanels(){return[...this.body.assignedElements()].filter((t=>"sl-tab-panel"===t.tagName.toLowerCase()))}getActiveTab(){return this.tabs.find((t=>t.active))}handleClick(t){const a=t.target.closest("sl-tab");(null==a?void 0:a.closest("sl-tab-group"))===this&&null!==a&&this.setActiveTab(a,{scrollBehavior:"smooth"})}handleKeyDown(t){const a=t.target.closest("sl-tab");if((null==a?void 0:a.closest("sl-tab-group"))===this&&(["Enter"," "].includes(t.key)&&null!==a&&(this.setActiveTab(a,{scrollBehavior:"smooth"}),t.preventDefault()),["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Home","End"].includes(t.key))){const a=this.tabs.find((t=>t.matches(":focus"))),e="rtl"===this.localize.dir();if("sl-tab"===(null==a?void 0:a.tagName.toLowerCase())){let o=this.tabs.indexOf(a);"Home"===t.key?o=0:"End"===t.key?o=this.tabs.length-1:["top","bottom"].includes(this.placement)&&t.key===(e?"ArrowRight":"ArrowLeft")||["start","end"].includes(this.placement)&&"ArrowUp"===t.key?o--:(["top","bottom"].includes(this.placement)&&t.key===(e?"ArrowLeft":"ArrowRight")||["start","end"].includes(this.placement)&&"ArrowDown"===t.key)&&o++,o<0&&(o=this.tabs.length-1),o>this.tabs.length-1&&(o=0),this.tabs[o].focus({preventScroll:!0}),"auto"===this.activation&&this.setActiveTab(this.tabs[o],{scrollBehavior:"smooth"}),["top","bottom"].includes(this.placement)&&(0,r.Rt)(this.tabs[o],this.nav,"horizontal"),t.preventDefault()}}}handleScrollToStart(){this.nav.scroll({left:"rtl"===this.localize.dir()?this.nav.scrollLeft+this.nav.clientWidth:this.nav.scrollLeft-this.nav.clientWidth,behavior:"smooth"})}handleScrollToEnd(){this.nav.scroll({left:"rtl"===this.localize.dir()?this.nav.scrollLeft-this.nav.clientWidth:this.nav.scrollLeft+this.nav.clientWidth,behavior:"smooth"})}setActiveTab(t,a){if(a=(0,d.IA)({emitEvents:!0,scrollBehavior:"auto"},a),t!==this.activeTab&&!t.disabled){const e=this.activeTab;this.activeTab=t,this.tabs.forEach((t=>t.active=t===this.activeTab)),this.panels.forEach((t=>{var a;return t.active=t.name===(null==(a=this.activeTab)?void 0:a.panel)})),this.syncIndicator(),["top","bottom"].includes(this.placement)&&(0,r.Rt)(this.activeTab,this.nav,"horizontal",a.scrollBehavior),a.emitEvents&&(e&&this.emit("sl-tab-hide",{detail:{name:e.panel}}),this.emit("sl-tab-show",{detail:{name:this.activeTab.panel}}))}}setAriaLabels(){this.tabs.forEach((t=>{const a=this.panels.find((a=>a.name===t.panel));a&&(t.setAttribute("aria-controls",a.getAttribute("id")),a.setAttribute("aria-labelledby",t.getAttribute("id")))}))}repositionIndicator(){const t=this.getActiveTab();if(!t)return;const a=t.clientWidth,e=t.clientHeight,o="rtl"===this.localize.dir(),s=this.getAllTabs(),i=s.slice(0,s.indexOf(t)).reduce(((t,a)=>({left:t.left+a.clientWidth,top:t.top+a.clientHeight})),{left:0,top:0});switch(this.placement){case"top":case"bottom":this.indicator.style.width=`${a}px`,this.indicator.style.height="auto",this.indicator.style.translate=o?-1*i.left+"px":`${i.left}px`;break;case"start":case"end":this.indicator.style.width="auto",this.indicator.style.height=`${e}px`,this.indicator.style.translate=`0 ${i.top}px`}}syncTabsAndPanels(){this.tabs=this.getAllTabs({includeDisabled:!1}),this.panels=this.getAllPanels(),this.syncIndicator(),this.updateComplete.then((()=>this.updateScrollControls()))}updateScrollControls(){this.noScrollControls?this.hasScrollControls=!1:this.hasScrollControls=["top","bottom"].includes(this.placement)&&this.nav.scrollWidth>this.nav.clientWidth}syncIndicator(){this.getActiveTab()?(this.indicator.style.display="block",this.repositionIndicator()):this.indicator.style.display="none"}show(t){const a=this.tabs.find((a=>a.panel===t));a&&this.setActiveTab(a,{scrollBehavior:"smooth"})}render(){const t="rtl"===this.localize.dir();return s.qy`
    ...
    `}};u.styles=i,u.dependencies={"sl-icon-button":l.h},(0,d.Cc)([(0,h.P)(".tab-group")],u.prototype,"tabGroup",2),(0,d.Cc)([(0,h.P)(".tab-group__body")],u.prototype,"body",2),(0,d.Cc)([(0,h.P)(".tab-group__nav")],u.prototype,"nav",2),(0,d.Cc)([(0,h.P)(".tab-group__indicator")],u.prototype,"indicator",2),(0,d.Cc)([(0,h.wk)()],u.prototype,"hasScrollControls",2),(0,d.Cc)([(0,h.MZ)()],u.prototype,"placement",2),(0,d.Cc)([(0,h.MZ)()],u.prototype,"activation",2),(0,d.Cc)([(0,h.MZ)({attribute:"no-scroll-controls",type:Boolean})],u.prototype,"noScrollControls",2),(0,d.Cc)([(0,c.w)("noScrollControls",{waitUntilFirstUpdate:!0})],u.prototype,"updateScrollControls",1),(0,d.Cc)([(0,c.w)("placement",{waitUntilFirstUpdate:!0})],u.prototype,"syncIndicator",1),u.define("sl-tab-group"),e(2846),e(3280),e(7352),e(7464),e(4415),e(4637),e(8326)},9638:(t,a,e)=>{var o=e(7324),s=e(5024),i=s.AH`
  ${o.$}
...
`,r=e(5794),l=e(7489),n=e(7012),c=e(3788),b=e(2489),d=0,p=class extends l.f{constructor(){super(...arguments),this.attrId=++d,this.componentId=`sl-tab-panel-${this.attrId}`,this.name="",this.active=!1}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId,this.setAttribute("role","tabpanel")}handleActiveChange(){this.setAttribute("aria-hidden",this.active?"false":"true")}render(){return s.qy`
      <slot
        part="base"
        class=${(0,c.H)({"tab-panel":!0,"tab-panel--active":this.active})}
      ></slot>
    `}};p.styles=i,(0,n.Cc)([(0,b.MZ)({reflect:!0})],p.prototype,"name",2),(0,n.Cc)([(0,b.MZ)({type:Boolean,reflect:!0})],p.prototype,"active",2),(0,n.Cc)([(0,r.w)("active")],p.prototype,"handleActiveChange",1),p.define("sl-tab-panel")},6938:(t,a,e)=>{var o=e(7324),s=e(5024),i=s.AH`
  ${o.$}
...
`,r=e(1382),l=e(333),n=e(5794),c=e(7489),b=e(7012),d=e(3788),p=e(2489),h=0,u=class extends c.f{constructor(){super(...arguments),this.localize=new l.c(this),this.attrId=++h,this.componentId=`sl-tab-${this.attrId}`,this.panel="",this.active=!1,this.closable=!1,this.disabled=!1}connectedCallback(){super.connectedCallback(),this.setAttribute("role","tab")}handleCloseClick(t){t.stopPropagation(),this.emit("sl-close")}handleActiveChange(){this.setAttribute("aria-selected",this.active?"true":"false")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}focus(t){this.tab.focus(t)}blur(){this.tab.blur()}render(){return this.id=this.id.length>0?this.id:this.componentId,s.qy`
      <div
        part="base"
    ...
    `}};u.styles=i,u.dependencies={"sl-icon-button":r.h},(0,b.Cc)([(0,p.P)(".tab")],u.prototype,"tab",2),(0,b.Cc)([(0,p.MZ)({reflect:!0})],u.prototype,"panel",2),(0,b.Cc)([(0,p.MZ)({type:Boolean,reflect:!0})],u.prototype,"active",2),(0,b.Cc)([(0,p.MZ)({type:Boolean})],u.prototype,"closable",2),(0,b.Cc)([(0,p.MZ)({type:Boolean,reflect:!0})],u.prototype,"disabled",2),(0,b.Cc)([(0,n.w)("active")],u.prototype,"handleActiveChange",1),(0,b.Cc)([(0,n.w)("disabled")],u.prototype,"handleDisabledChange",1),u.define("sl-tab"),e(2846),e(3280),e(7352),e(7464),e(4415),e(4637),e(8326)}}]);
//# sourceMappingURL=196.f83d2dd4.js.map